...
<body>  
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href="products.php" title="Shop Now">
        ...
        <li><a href="cart.php" title="Your Cart">
        <?php
        ...
        <li><a href="aboutus.php" title="About Us">
        ...
        <li><a href="contact.php" title="Contact Us">
          ...
          <?php if(isset($_SESSION['email'])) { ?>
            <li><a href="profile.php" title="Your Profile">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
            ...
            <?php } else { ?>
              <li><a href="login.php" title="Login">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
           </svg></a></li>
